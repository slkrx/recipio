            ...
            <div className="flex flex-col items-center justify-center px-6 py-8">
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6 font-outfit" onSubmit={handleSubmit}>
                            <div>
                            ...
                            <button
                                type="submit"
                                className="w-full text-rose-white bg-water hover:bg-water-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                            >
                                Sign in
                            </button>
                            {errors.map((error, i) => {
                            ...
                            <p className="text-sm font-light text-blue-gray">
                                Don’t have an account yet? <Link to="/register" className="font-medium text-water hover:underline">Sign up</Link>
                            </p>
                        </form>
                    </div>
                </div>
